...
<head>
    ...
    <title>Conditions d'Utilisation - Budget Mariage</title>
    ...
    <div class="privacy-container">
        ...
        <div class="privacy-content">
            <div class="section">
                ...
                <p>En accédant et en utilisant Budget Mariage PJPM, vous acceptez d'être lié par ces conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service.</p>
            </div>

            <div class="section">
                <h2>2. Description du service</h2>
                <p>Budget Mariage PJPM est une plateforme de gestion de budget de mariage qui permet aux utilisateurs de :</p>
                <ul>
            ...
            <div class="section">
                ...
                <p>Ces conditions sont régies par les lois de la République de Côte d'Ivoire. Tout litige relève de la compétence des tribunaux d'Abidjan.</p>
            </div>
