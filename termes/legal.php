...
<head>
    ...
    <title>Mentions Légales - Budget Mariage</title>
...
<body>
    <div class="privacy-container">
        <div class="privacy-header">
            ...
            <p>Informations légales concernant Budget Mariage PJPM</p>
        </div>

        <div class="privacy-content">
            <div class="section">
                <h2>1. Éditeur du site</h2>
                <p><strong>Nom :</strong> Budget Mariage PJPM</p>
            ...
            <div class="section">
                <h2>2. Hébergement</h2>
                <p><strong>Hébergeur :</strong> XAMPP Local Server</p>
            ...
            <div class="section">
                ...
                <p>Tous les éléments du site (textes, images, logos, design, code source) sont la propriété exclusive de Budget Mariage PJPM ou font l'objet d'une autorisation d'utilisation.</p>
            ...
            <div class="section">
                ...
                <!--<p>
                Pour exercer ces droits ou pour toute question, contactez notre Délégué à la Protection 
                des Données (DPD) à l'adresse : 
                <a href="mailto:dpd@jesuspourvoitaumenage.bj">dpd@jesuspourvoitaumenage.bj</a>
                </p>-->
                
                <p>
                    <small>
                        <i class="fas fa-balance-scale"></i>
                        Références légales : Loi N° 2017-20 du 20/04/2018 (Code du numérique) et 
                        Loi N° 2009-09 du 22/05/2009 (Protection des données)
                    </small>
                </p>
            </div>
            ...
            <div class="section">
                ...
                <p>Budget Mariage PJPM s'efforce d'assurer l'exactitude des informations publiées sur le site. Cependant, nous ne pouvons garantir :</p>
                <ul>
