...
<style>
.guide-container{max-width:1100px;margin:90px auto 40px;padding:20px}
.guide-hero{background:linear-gradient(135deg,var(--primary),var(--primary-dark));color:white;padding:50px 40px;border-radius:20px;text-align:center;margin-bottom:48px;position:relative;overflow:hidden}
.guide-hero::before{content:'';position:absolute;top:-60px;right:-60px;width:250px;height:250px;background:radial-gradient(circle,rgba(255,255,255,.12),transparent 70%);border-radius:50%}
.guide-hero h1{font-family:'Playfair Display',serif;font-size:2.6rem;margin-bottom:12px;position:relative}
.guide-hero p{opacity:.9;font-size:1.1rem;position:relative}
...
.tl-item{display:flex;margin-bottom:50px;position:relative;align-items:flex-start}
.tl-item:nth-child(odd) .tl-content{margin-left:calc(50% + 50px)}
.tl-item:nth-child(even) .tl-content{margin-right:calc(50% + 50px);text-align:right}
.tl-marker{position:absolute;left:50%;transform:translateX(-50%);width:56px;height:56px;background:linear-gradient(135deg,var(--primary),var(--primary-light));border-radius:50%;display:flex;align-items:center;justify-content:center;color:white;font-size:1.4rem;box-shadow:0 4px 16px var(--shadow);z-index:10;top:20px;flex-shrink:0}
.tl-content{width:calc(50% - 50px);background:var(--bg-card);padding:28px;border-radius:16px;box-shadow:0 5px 20px var(--shadow);transition:transform .3s,box-shadow .3s}
.tl-content:hover{transform:translateY(-4px);box-shadow:0 10px 30px var(--shadow)}
.step-badge{display:inline-block;background:var(--secondary);color:white;padding:4px 14px;border-radius:20px;font-weight:700;font-size:.85rem;margin-bottom:12px}
.step-title{font-family:'Playfair Display',serif;font-size:1.5rem;color:var(--primary);margin-bottom:12px}
.step-desc{color:var(--text-secondary);line-height:1.8;margin-bottom:16px;font-size:.95rem}
.step-list{list-style:none;padding:0;margin:0}
.step-list li{padding:7px 0 7px 28px;position:relative;color:var(--text-secondary);font-size:.93rem;border-bottom:1px solid var(--border)}
.step-list li:last-child{border-bottom:none}
.step-list li::before{content:'✓';position:absolute;left:0;color:var(--success);font-weight:700;font-size:1rem}
.step-tip{background:#e3f2fd;padding:14px;border-radius:8px;margin-top:14px;border-left:4px solid #2196f3;font-size:.9rem}
.step-tip strong{color:#1565c0}
.step-duration{display:inline-flex;align-items:center;gap:6px;background:var(--bg-main);padding:6px 14px;border-radius:8px;font-size:.85rem;color:var(--text-secondary);margin-top:14px}
.btn-cta{display:inline-flex;align-items:center;gap:10px;padding:16px 40px;background:linear-gradient(135deg,var(--primary),var(--primary-light));color:white;text-decoration:none;border-radius:12px;font-weight:700;font-size:1.05rem;box-shadow:0 6px 20px var(--shadow);transition:transform .3s,box-shadow .3s;margin:8px}
.btn-cta:hover{transform:translateY(-3px);box-shadow:0 10px 30px var(--shadow)}
.btn-cta-sec{background:linear-gradient(135deg,var(--secondary),#c9a438)}
@media(max-width:768px){
  .timeline::before{left:28px}
  .tl-item{flex-direction:column}
  .tl-item:nth-child(odd) .tl-content,.tl-item:nth-child(even) .tl-content{margin:0 0 0 70px;width:calc(100% - 80px);text-align:left}
  .tl-marker{left:28px}
  ...
  <div class="timeline">
    ...
    <div class="tl-item">
      ...
      <div class="tl-content">
        ...
        <ul class="step-list">
          <li><strong style="color :red">Vérifier que votre acte de mariage est bien déposé sans lequel votre mariage sera suspendu</strong></li>
