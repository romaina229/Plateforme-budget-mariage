<?php
/**
 * index_mobile.php — Interface Mobile Native
 */
...
<title>Budget Mariage — PJPM</title>
...
<style>
/* ================================================
   DESIGN SYSTEM — BUDGET MARIAGE MOBILE v2.1
...
<div id="app">
  ...
  <header class="app-header">
    <div class="header-logo">
      ...
      <h1 class="serif">Budget <span>Mariage</span></h1>
    </div>
  ...
  <main class="app-content">
    ...
    <section id="page-dashboard" class="page active">
      <div class="hero-banner">
        ...
        <h2 class="hero-title serif">Votre <span>mariage</span><br>mérite le meilleur</h2>
        <div class="countdown-widget" id="countdown-widget">
          <div class="cd-icon">💒</div>
          <div class="cd-info">
            <div class="cd-label">Compte à rebours</div>
            <div class="cd-date serif" id="cd-date-text">—</div>
            <div><span class="cd-days" id="cd-days">—</span><span class="cd-suf" id="cd-suf"> jours restants</span></div>
          </div>
          <button class="cd-edit-btn" onclick="App.openDateModal()"><i class="fas fa-edit"></i></button>
        </div>
      </div>
...
const App = {
  ...
  renderGuide() {
    const steps = [
      {icon:'💌',badge:'Étape 1',title:'Fiançailles & Annonce',desc:'Le début de l\'aventure : officialiser votre amour et annoncer la grande nouvelle.',checks:['Demander la main en mariage','Choisir la bague de fiançailles','Annoncer la nouvelle à la famille','Organiser une petite réception de fiançailles'],time:'12 à 18 mois avant'},
      {icon:'📋',badge:'Étape 2',title:'Préparatifs Officiels',desc:'Les démarches administratives et juridiques indispensables.',checks:['Déposer le dossier de mariage civil','Choisir entre mariage civil, religieux ou les deux','Prendre rendez-vous à la mairie ou à l\'église','Préparer les documents officiels (actes de naissance…)'],time:'12 mois avant'},
      {icon:'💰',badge:'Étape 3',title:'Budget & Financement',desc:'Définir votre budget global et planifier les dépenses.',checks:['Établir un budget total réaliste','Répartir le budget par catégorie','Identifier les sources de financement','Créer un tableau de suivi des dépenses'],time:'12 à 9 mois avant'},
      {icon:'🏛️',badge:'Étape 4',title:'Lieux & Prestataires',desc:'Réserver les lieux et sélectionner les meilleurs prestataires.',checks:['Visiter et réserver la salle de réception','Contacter et comparer les traiteurs','Choisir le photographe / vidéaste','Sélectionner DJ ou orchestre','Rencontrer le maître de cérémonie'],time:'9 à 6 mois avant'},
      {icon:'💒',badge:'Étape 5',title:'Tenues & Cérémonie',desc:'Les tenues du grand jour et la préparation de la cérémonie.',checks:['Choisir et commander la robe de mariée','Acheter ou louer le costume','Sélectionner les tenues du cortège','Organiser les essayages','Préparer les vœux et discours'],time:'6 à 3 mois avant'},
      {icon:'🥂',badge:'Étape 6',title:'Réception & Fête',desc:'Célébration avec vos invités : repas, animations et moments de joie.',checks:['Finaliser le menu avec le traiteur','Confirmer la décoration','Préparer la liste de chansons','Commander le gâteau de mariage','Envoyer les faire-part définitifs'],time:'3 à 1 mois avant'},
      {icon:'🚛',badge:'Étape 7',title:'Logistique & Derniers Détails',desc:'Coordination finale pour le bon déroulement du jour J.',checks:['Organiser le transport des invités','Préparer les cadeaux des invités','Finaliser le plan de table','Prévoir une liste de contact d\'urgence','Répétition de la cérémonie'],time:'1 mois avant'},
      {icon:'❤️',badge:'Étape Finale',title:'Après le Mariage',desc:'Les formalités et beaux moments qui suivent la célébration.',checks:['Récupérer les photos et vidéos','Envoyer les remerciements','Retirer le livret de famille','Informer les organismes du changement de nom','Commencer à installer le foyer'],gold:true,time:'Après le mariage'},
    ];
