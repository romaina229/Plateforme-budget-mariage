  ...
  <div class="footer-grid">
    ...
    <div class="fc">
      ...
      <div class="fsocial" role="list" aria-label="Réseaux sociaux">
        ...
        <a href="https://instagram.com/" class="fsoc ig" target="_blank" rel="noopener" role="listitem" aria-label="Instagram">
...
.site-footer{background:linear-gradient(135deg,#5d2f5f 0%,#8b4f8d 100%);
  color:#fff;padding:50px 20px 20px;margin-top:60px;}
...
.flogo{display:flex;align-items:center;gap:10px;font-family:'Playfair Display',serif;
  font-size:1.4rem;color:#d4af37;margin-bottom:12px;}
.flogo i{font-size:1.6rem;}
