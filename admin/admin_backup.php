...
<body>
    ...
    <div class="backup-container">
        ...
        <div class="backup-actions">
            ...
            <div class="backup-card">
                ...
                <h3>Restaurer</h3>
                <p>Restaurer la base de données depuis un fichier</p>
    ...
    function createBackup() {
        ...
        fetch('admin_api.php?action=create_backup')
    ...
    function restoreBackup() {
        ...
        fetch('admin_api.php?action=restore_backup', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
    ...
    function restoreSpecificBackup(filename) {
        if (!confirm(`Restaurer la sauvegarde "${filename}" ? Cette action va écraser la base de données actuelle.`)) {
            return;
        }

        fetch('admin_api.php?action=restore_specific_backup', {
            method: 'POST',
            headers: {
    ...
    function deleteBackup(filename) {
        ...
        fetch('admin_api.php?action=delete_backup', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
